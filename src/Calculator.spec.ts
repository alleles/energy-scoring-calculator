    ...
    () => {
        ...
        describe('with correct formulas:',
            () => {
                ...
                it('Calc_Spaces_03', () => { expectations = { formula: ' 0 ', expectedResult: 0 }; });

                it('Calc_Spaces_04', () => { expectations = { formula: ' 1', expectedResult: 1 }; });

                it('Calc_Spaces_05', () => { expectations = { formula: ' 1 ', expectedResult: 1 }; });

                it('Calc_Spaces_06', () => { expectations = { formula: '1 ', expectedResult: 1 }; });

                it('Calc_Spaces_07', () => { expectations = { formula: '1 +1', expectedResult: 2 }; });

                it('Calc_Spaces_08', () => { expectations = { formula: '10 +1', expectedResult: 11 }; });

                it('Calc_Spaces_09', () => { expectations = { formula: '1 + 12 ', expectedResult: 13 }; });

                it('Calc_Spaces_10', () => { expectations = { formula: '1*12+14* 7', expectedResult: 110 }; });

                it('Calc_Spaces_11',
                    () => { expectations = { formula: '1 * 12 + 14 * 7', expectedResult: 110 }; });

                it('Calc_Comments_01',
                    () => { expectations = { formula: '1+/*Hello please ignore me*/7', expectedResult: 8 }; });

                it('Calc_Comments_02',
                    () => { expectations = { formula: '7^/*Hello please ignore me*/7', expectedResult: 823543 }; });
                ...
                it('Calc_SevenTimesSeven', () => { expectations = { formula: '7^7', expectedResult: 823543 }; });

                it('Calc_SingleZero', () => { expectations = { formula: '0', expectedResult: 0 }; });

                it('Calc_SingleZeroParenthesed', () => { expectations = { formula: '(0)', expectedResult: 0 }; });

                it('Calc_SingleOne', () => { expectations = { formula: '1', expectedResult: 1 }; });

                it('Calc_SingleOneParenthesed', () => { expectations = { formula: '(1)', expectedResult: 1 }; });

                it('Calc_SingleNine', () => { expectations = { formula: '9', expectedResult: 9 }; });

                it('Calc_EmptyString', () => { expectations = { formula: '', expectedResult: 0 }; });

                it('Calc_NullString', () => { expectations = { formula: null, expectedResult: 0 }; });

                it('Calc_OnePlusOne', () => { expectations = { formula: '1+1', expectedResult: 2 }; });

                it('Calc_OneTimesOne', () => { expectations = { formula: '1*1', expectedResult: 1 }; });

                it('Calc_ZeroTimesOne', () => { expectations = { formula: '0*1', expectedResult: 0 }; });

                it('Calc_OneMinusOne', () => { expectations = { formula: '1-1', expectedResult: 0 }; });

                it('Calc_OneToThePowerOfOne', () => { expectations = { formula: '1^1', expectedResult: 1 }; });

                it('Calc_OneToThePowerOfZero', () => { expectations = { formula: '1^0', expectedResult: 1 }; });

                it('Calc_FourToThePowerOfFour', () => { expectations = { formula: '4^4', expectedResult: 256 }; });

                it('Calc_TenToThePowerOfThree', () => { expectations = { formula: '10^3', expectedResult: 1000 }; });

                it('Calc_TenExponentThree', () => { expectations = { formula: '8e+3', expectedResult: 8000 }; });
                ...
                it('Calc_PiCaseVariant_01', () => { expectations = { formula: 'pi', expectedResult: Math.PI }; });

                it('Calc_PiCaseVariant_02', () => { expectations = { formula: 'Pi', expectedResult: Math.PI }; });

                it('Calc_PiCaseVariant_03', () => { expectations = { formula: 'pI', expectedResult: Math.PI }; });

                it('Calc_PiCaseVariant_04', () => { expectations = { formula: 'PI', expectedResult: Math.PI }; });
                ...
                it('Calc_Sin42', () => { expectations = { formula: 'SIN(43)', expectedResult: Math.sin(43) }; });

                it('Calc_2Plus2', () => { expectations = { formula: '2+2', expectedResult: 4 }; });

                it('Calc_2Plus3Plus4', () => { expectations = { formula: '2+3+4', expectedResult: 9 }; });

                it('Calc_2Minus5Plus4', () => { expectations = { formula: '2-5+4', expectedResult: 1 }; });

                it('Calc_2PlusOpenParen2Minus3CloseParen',
                    () => { expectations = { formula: '2+(2-3)', expectedResult: 1 }; });

                it('Calc_2Times2Plus8Plus3', () => { expectations = { formula: '2*2+8+3', expectedResult: 15 }; });

                it('Calc_2Divided4Plus1', () => { expectations = { formula: '2/4+1', expectedResult: 1.5 }; });

                it('Calc_2Pow3Plus2DoubleStar3', () => { expectations = { formula: '2^3+2**3', expectedResult: 16 }; });

                it('Calc_1Plus3Times4Pow2', () => { expectations = { formula: '1+3*4^2', expectedResult: 49 }; });

                it('Calc_2Tilde4', () => { expectations = { formula: '2~4', expectedResult: 2 }; });

                it('Calc_3Rooted4', () => { expectations = { formula: '3//4', expectedResult: 1.5874010519682 }; });

                it('Calc_12Mod2Pow2', () => { expectations = { formula: '13Mod2^2', expectedResult: 1 }; });

                it('Calc_12Plus2Pow7div3', () => { expectations = { formula: '12+2*7div3', expectedResult: 16 }; });

                it('Calc_7div3', () => { expectations = { formula: '7div2', expectedResult: 3 }; });

                it('Calc_2Powpi', () => { expectations = { formula: '2*pi', expectedResult: 6.28318530717959 }; });

                it('Calc_3TimesE', () => { expectations = { formula: '3*e', expectedResult: 8.15484548537714 }; });
                ...
                it('Calc_sqrOpenParen7CloseParen', () => { expectations = { formula: 'sqr(7)', expectedResult: 49 }; });
                ...
                it('Calc_sinOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'sin(13,488)', expectedResult: 0.796587678143574 }; });

                it('Calc_cosOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'cos(13,488)', expectedResult: 0.604523011166514 }; });
                ...
                it('Calc_cotOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'cot(13,488)', expectedResult: 0.758890738274208 }; });

                it('Calc_sinhOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'sinh(13,488)', expectedResult: 360357.840971781 }; });

                it('Calc_coshOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'cosh(13,488)', expectedResult: 360357.840973168 }; });

                it('Calc_tanhOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'tanh(13,488)', expectedResult: 0.99999999999615 }; });

                it('Calc_arcsinOpenParen0Comma3TimespiCloseParen',
                    () => { expectations = { formula: 'arcsin(0,3*pi)', expectedResult: 1.22996707330454 }; });

                it('Calc_arccosOpenParen0Comma3TimespiCloseParen',
                    () => { expectations = { formula: 'arccos(0,3*pi)', expectedResult: 0.340829253490361 }; });

                it('Calc_arctanOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'arctan(13,488)', expectedResult: 1.49679174688414 }; });

                it('Calc_arctan2OpenParen1Semicolon1CloseParen',
                    () => { expectations = { formula: 'arctan2(1;1)', expectedResult: 0.785398163397448 }; });

                it('Calc_arccotOpenParen0Comma4TimespiCloseParen',
                    () => { expectations = { formula: 'arccot(0,4*pi)', expectedResult: 0.672159233738554 }; });

                it('Calc_expOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'exp(13,488)', expectedResult: 720715.681944949 }; });
                ...
                it('Calc_eexOpenParen3Comma488CloseParen',
                    () => { expectations = { formula: 'eex(3,488)', expectedResult: 3076.09681474071 }; });

                it('Calc_logOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'log(13,488)', expectedResult: 1.12994755728067 }; });

                it('Calc_radOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'rad(13,488)', expectedResult: 0.235410009508995 }; });

                it('Calc_degOpenParen13Comma488CloseParen',
                    () => { expectations = { formula: 'deg(13,488)', expectedResult: 772.805474072454 }; });

                it('Calc_NumberFormat_01', () => { expectations = { formula: '12,12', expectedResult: 12.12 }; });

                it('Calc_NumberFormat_02', () => { expectations = { formula: '12.12', expectedResult: 12.12 }; });

                it('Calc_NumberFormat_03', () => { expectations = { formula: '1,212', expectedResult: 1.212 }; });

                it('Calc_NumberFormat_04', () => { expectations = { formula: '1.212', expectedResult: 1.212 }; });

                it('Calc_NumberFormat_05', () => { expectations = { formula: '121,2', expectedResult: 121.2 }; });

                it('Calc_NumberFormat_06', () => { expectations = { formula: '121.2', expectedResult: 121.2 }; });

                it('UnaryMinus_01', () => { expectations = { formula: '-2', expectedResult: -2 }; });

                it('UnaryMinus_02', () => { expectations = { formula: '(-2)', expectedResult: -2 }; });

                it('UnaryMinus_03', () => { expectations = { formula: '-(-2)', expectedResult: 2 }; });

                it('UnaryMinus_04', () => { expectations = { formula: '(-2)+1', expectedResult: -1 }; });
